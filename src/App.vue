<template>
  <div class="chat-container">
    ...
    <div class="input-container">
      <input @keyup.enter="sendMessage" v-model="newMessage" placeholder="Text here..." />
  ...
  methods: {
    sendMessage() {
      if (this.newMessage.trim() !== "") {
        ...
        // Simulate receiving message from another sender after a delay
        setTimeout(() => {
          const response = {
            id: Date.now(),
            sender: "stranger",
        ...
        }, Math.floor(Math.random() * 6000) + 5000); // Random delay between 5-10 seconds
      }
    },
    deleteMessage(id) {
